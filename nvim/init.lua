...
vim.opt.autocomplete = false -- Don't auto-show completion menu (open manually).
vim.opt.completeopt = { "menu", "menuone" }

-- Only use omnifunc (LSP) results since buffer keywords unfortunately sort
-- first if those are also included.
--
-- TODO: Fix this.
vim.opt.complete = { "o" }
